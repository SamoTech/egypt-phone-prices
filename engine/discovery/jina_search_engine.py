...
class JinaSearchEngine:
    ...
    def __init__(self, timeout: int = 15):
        ...
        self.session.headers.update({
            ...
            'User-Agent': 'Egypt-Phone-Prices/1.0'
        })
    ...
    def search(self, query: str, max_results: int = 10, region: str = "eg") -> List[Dict[str, Any]]:
        """
        ...
        try:
            ...
            logger.error(f"Jina AI search failed for query '{query}': {type(e).__name__}: {e}")
