...
class SearchResultParser:
    ...
    def parse_results(self, results: List[Dict[str, Any]], target_phone: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
    ...
    def _parse_single_result(self, result: Dict[str, Any], target_phone: Dict[str, Any]) -> Optional[Dict[str, Any]]:
